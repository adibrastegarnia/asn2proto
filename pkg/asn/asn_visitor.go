...
type ASNVisitor interface {
	...
	VisitModules(ctx *ModulesContext) interface{}
	...
	VisitComponentPresenceLists(ctx *ComponentPresenceListsContext) interface{}

	// Visit a parse tree produced by ASNParser#componentPresenceList.
	VisitComponentPresenceList(ctx *ComponentPresenceListContext) interface{}

	// Visit a parse tree produced by ASNParser#componentPresence.
	VisitComponentPresence(ctx *ComponentPresenceContext) interface{}
