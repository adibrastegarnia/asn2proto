...
func (v *BaseASNVisitor) VisitModules(ctx *ModulesContext) interface{} {
...
func (v *BaseASNVisitor) VisitComponentPresenceLists(ctx *ComponentPresenceListsContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseASNVisitor) VisitComponentPresenceList(ctx *ComponentPresenceListContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseASNVisitor) VisitComponentPresence(ctx *ComponentPresenceContext) interface{} {
	return v.VisitChildren(ctx)
}
